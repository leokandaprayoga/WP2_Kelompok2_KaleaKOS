...
<head>
    ...
    <title> KaleaKOS | Cari kost-kostsan</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>Login"><img src="<?php echo base_url()?>assets/images/KaleaKOS.png" width="160px" align="center"></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2024 <a href="<?php echo base_url()?>Login">KaleaKosan</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.9.0
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Data User</h2><br>
                                <a href="<?php echo base_url()?>Main_Back_Admin/daftar_user">
                                ...
                                <?php foreach ($user as $u) { ?>
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <a href="<?php echo base_url('Main_Back_Admin/edit_user/'.$u->id_user)?>">
                                            <button type="button" class="btn btn-info waves-effect">Edit</button>
                                        </a>

                                        <a onclick="return confirm('Apa anda yakin akan menghapus data ini ?')" href="<?php echo base_url('Main_Back_Admin/hapus_user/'.$u->id_user)?>">
